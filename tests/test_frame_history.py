...
from chordelay.chords import find_onset_frame
from chordelay.chroma import FRAME_SECONDS, FrameHistory
from chordelay.cli import MAX_ONSET_SEARCH, _locate_onset
...
def _fenster_frames(akkord_bei, window_start, window_laenge=FENSTER):
    ...
    from chordelay.chroma import NOTE_NAMES

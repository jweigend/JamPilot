...
| Anzeige | `index.html` `.beat` / `.beat.bar` | kurze Ticks am Boden (Eins doppelt so hoch), hinter den Chips, sonst nichts - Linien ueber die ganze Spur (hinter wie vor den Chips) und eine Kante am Chip der Eins waren im Playtest zu unruhig (10.09.: "stoert kaum, bringt Orientierung"); Schalter im Zahnrad (`jampilot.beats`, pro Geraet, Standard an); dieselbe Formel und Uhr wie die Chips, kein Client-Raster |

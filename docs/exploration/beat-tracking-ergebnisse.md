...
| Anzeige | `index.html` `.beat` / `.beat.bar` | Eins als duenne Linie ueber die ganze Spurhoehe, VOR den Chips (Nutzerentscheid 10.09.), andere Schlaege als Hauch am Boden; Schalter im Zahnrad (`jampilot.beats`, pro Geraet, Standard an); dieselbe Formel und Uhr wie die Chips, kein Client-Raster |
